...
const imageConfigSchema = new mongoose_1.Schema({
    ...
    serverVersion: { type: String, required: true, default: "1.20.1" },
    recommendedVersion: { type: String, required: true, default: "1.20.1" },
    ...
    dockerSettings: {
        serverJarName: { type: String, required: true, default: "server.jar" },
...
exports.default = (0, mongoose_1.model)('ImageConfig', imageConfigSchema, 'imageConfigs');
